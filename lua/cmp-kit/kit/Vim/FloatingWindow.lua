...
---@alias cmp-kit.kit.Vim.FloatingWindow.WindowKind 'main' | 'scrollbar_track' | 'scrollbar_thumb'

---@class cmp-kit.kit.Vim.FloatingWindow.BorderSize
...
---@class cmp-kit.kit.Vim.FloatingWindow.ContentSize
---@field public width integer
---@field public height integer

---@class cmp-kit.kit.Vim.FloatingWindow.WindowConfig
...
---@field public border_size cmp-kit.kit.Vim.FloatingWindow.BorderSize
---@field public content_size cmp-kit.kit.Vim.FloatingWindow.ContentSize
...
---@class cmp-kit.kit.Vim.FloatingWindow.Config
---@field public markdown? boolean

---@class cmp-kit.kit.Vim.FloatingWindow
---@field private _augroup string
---@field private _config cmp-kit.kit.Vim.FloatingWindow.Config
...
---@return cmp-kit.kit.Vim.FloatingWindow.ContentSize
...
---@param params { border_size: cmp-kit.kit.Vim.FloatingWindow.BorderSize, content_size: cmp-kit.kit.Vim.FloatingWindow.ContentSize, max_outer_width: integer, max_outer_height: integer }
...
---Create window.
---@return cmp-kit.kit.Vim.FloatingWindow
function FloatingWindow.new()
  return setmetatable({
    _augroup = vim.api.nvim_create_augroup(('cmp-kit.kit.Vim.FloatingWindow:%s'):format(kit.unique_id()), {
      clear = true,
    }),
    _config = {
      markdown = false,
...
---Get config.
---@return cmp-kit.kit.Vim.FloatingWindow.Config
function FloatingWindow:get_config()
  return self._config
end

---Set config.
---@param config cmp-kit.kit.Vim.FloatingWindow.Config
...
---@param key string
---@param value any
---@param kind? cmp-kit.kit.Vim.FloatingWindow.WindowKind
...
---@return cmp-kit.kit.Vim.FloatingWindow.Viewport
