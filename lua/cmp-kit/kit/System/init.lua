...
---@class cmp-kit.kit.System.Buffering
---@field create fun(self: any, callback: fun(data: string)): cmp-kit.kit.System.Buffer

---@class cmp-kit.kit.System.LineBuffering: cmp-kit.kit.System.Buffering
...
---@class cmp-kit.kit.System.DelimiterBuffering: cmp-kit.kit.System.Buffering
...
---Spawn a new process.
---@class cmp-kit.kit.System.SpawnParams
---@field cwd string
...
---@field buffering? cmp-kit.kit.System.Buffering
---@param command string[]
---@param params cmp-kit.kit.System.SpawnParams
...
function System.spawn(command, params)
  ...
  local close --[[@type fun(signal?: integer): cmp-kit.kit.Async.AsyncTask]]
