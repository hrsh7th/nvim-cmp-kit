...
---@class cmp-kit.kit.RPC.JSON.Transport
---@field send fun(self: cmp-kit.kit.RPC.JSON.Transport, data: table): cmp-kit.kit.Async.AsyncTask
---@field on_message fun(self: cmp-kit.kit.RPC.JSON.Transport, callback: fun(data: table))
---@field start fun(self: cmp-kit.kit.RPC.JSON.Transport)
---@field close fun(self: cmp-kit.kit.RPC.JSON.Transport): cmp-kit.kit.Async.AsyncTask

---@class cmp-kit.kit.RPC.JSON.Transport.LineDelimitedPipe: cmp-kit.kit.RPC.JSON.Transport
---@field private _buffer cmp-kit.kit.buffer.Buffer
...
---@class cmp-kit.kit.RPC.JSON.RPC
---@field private _transport cmp-kit.kit.RPC.JSON.Transport
...
---@param params { transport: cmp-kit.kit.RPC.JSON.Transport }
