...
local Cache = require('cmp-kit.kit.App.Cache')

---@class cmp-kit.kit.App.Config.Schema

---@alias cmp-kit.kit.App.Config.SchemaInternal cmp-kit.kit.App.Config.Schema|{ revision: integer }

---@class cmp-kit.kit.App.Config
---@field private _cache cmp-kit.kit.App.Cache
---@field private _default cmp-kit.kit.App.Config.SchemaInternal
---@field private _global cmp-kit.kit.App.Config.SchemaInternal
---@field private _filetype table<string, cmp-kit.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, cmp-kit.kit.App.Config.SchemaInternal>
local Config = {}
Config.__index = Config

---Create new config instance.
---@param default cmp-kit.kit.App.Config.Schema
...
---@param config cmp-kit.kit.App.Config.Schema
...
---@return cmp-kit.kit.App.Config.Schema
function Config:get()
...
---@return fun(config: cmp-kit.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: cmp-kit.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: cmp-kit.kit.App.Config.Schema) }
