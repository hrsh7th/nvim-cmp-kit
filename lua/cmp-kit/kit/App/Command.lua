---@class cmp-kit.kit.App.Command.SubCommand.Argument
---@field public complete? fun(prefix: string):string[]
---@field public required? boolean

---@class cmp-kit.kit.App.Command.SubCommandSpecifier
---@field public desc? string
---@field public args? table<string|number, cmp-kit.kit.App.Command.SubCommand.Argument>
---@field public execute fun(params: cmp-kit.kit.App.Command.ExecuteParams, arguments: table<string, string>)

---@class cmp-kit.kit.App.Command.SubCommand: cmp-kit.kit.App.Command.SubCommandSpecifier
---@field public name string
---@field public args table<string|number, cmp-kit.kit.App.Command.SubCommand.Argument>

---@class cmp-kit.kit.App.Command
---@field public name string
---@field public subcommands table<string, cmp-kit.kit.App.Command.SubCommand>
local Command = {}
Command.__index = Command

---Create a new command.
---@param name string
---@param subcommand_specifiers table<string, cmp-kit.kit.App.Command.SubCommandSpecifier>
...
---@class cmp-kit.kit.App.Command.ExecuteParams
---@field public name string
...
---Execute command.
---@param params cmp-kit.kit.App.Command.ExecuteParams
