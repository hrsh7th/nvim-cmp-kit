local LanguageId = require('cmp-kit.kit.LSP.LanguageId')
...
--@alias cmp-kit.kit.LSP.TextDocumentFilter ({ language: string, scheme?: string, pattern?: string } | { language?: string, scheme: string, pattern?: string } | { language?: string, scheme?: string, pattern: string })
...
--@alias cmp-kit.kit.LSP.NotebookDocumentFilter ({ notebookType: string, scheme?: string, pattern?: string } | { notebookType?: string, scheme: string, pattern?: string } | { notebookType?: string, scheme?: string, pattern: string })

---@alias cmp-kit.kit.LSP.DocumentSelector.NormalizedFilter { notebook_type: string?, scheme: string?, pattern: string, language: string? }

---Normalize the filter.
---@param document_filter cmp-kit.kit.LSP.DocumentFilter
---@return cmp-kit.kit.LSP.DocumentSelector.NormalizedFilter | nil
local function normalize_filter(document_filter)
  if document_filter.notebook then
    local filter = document_filter --[[@as cmp-kit.kit.LSP.NotebookCellTextDocumentFilter]]
    ...
    local filter = document_filter --[[@as cmp-kit.kit.LSP.TextDocumentFilter]]
    return {
      notebook_type = nil,
...
---@param filter? cmp-kit.kit.LSP.DocumentSelector.NormalizedFilter
---@param uri string
...
---@param bufnr integer
---@param document_selector cmp-kit.kit.LSP.DocumentSelector
