...
---@class cmp-kit.kit.Async.AsyncTask
---@field private value any
---@field private status cmp-kit.kit.Async.AsyncTask.Status
...
---@param task cmp-kit.kit.Async.AsyncTask
---@param status cmp-kit.kit.Async.AsyncTask.Status
---@param value any
...
---@enum cmp-kit.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: cmp-kit.kit.Async.AsyncTask.Status, value: any }
